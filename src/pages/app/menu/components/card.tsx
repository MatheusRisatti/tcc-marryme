...
export function Card({ gift }: CardProps) {
  ...
  return (
    <>
      <div className="flex h-[450px] w-[350px] flex-col items-center justify-center rounded-2xl border-[0.5px] border-solid border-[#C9C9C9] duration-300 hover:-translate-y-2 hover:shadow-xl">
