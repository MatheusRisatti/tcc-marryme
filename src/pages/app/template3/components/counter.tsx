...
export function Counter({ couple }: HomeProps) {
  ...
  return (
    <>
      <div className="flex w-96 flex-col items-center justify-center text-[#B7A9A7]">
        <div className="flex gap-2">
          <div className="flex h-20 w-20 flex-col items-center justify-center rounded-xl border-[2px] border-[#B7A9A7]">
